			...
			?>
							...
							<div class="single-items">
								...
								<div class="item-content">
									<!--Title-->
								<a href="pro_details.php?id=<?php echo $pro_id; ?>" class="img-preview-btn">	<h4><?php echo $pro_title; ?></h4> </a>
									<!--Ratings-->
					...
					<div class="tab-content ProductCatagoryView " >
						<div id="grid-view" class="tab-pane GridProductView fade in active show">
							...
							if(isset($_GET["cid"]))
								...
								$cid = $_GET["cid"];
								include "db.php";
								$product_query = "SELECT * FROM products where product_cat = $cid";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			<div class="col-lg-3 pd" style="float:left">
									<div class="single-items">
									<?php 
											if($discount > 0)
											{
					...
					?><?php 
...

					   {
						...
						<?php
								...
								include "db.php";
								$product_query = "SELECT * FROM products limit 100";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
			...
			?>
				...
				<div class="col-lg-3 pd" style="float:left">
									...
									<?php 
											...
											{
											?>
											<span class="new-label1"><?php echo $discount ;?>% OFF</span>
		...
		$rating = $total_of_rate / $user;
					...
					?><?php 
...

					   {
						...
						<div id="list-view" class="tab-pane ListProductView fade">
							<!--Single List Product Items-->
							...
							if(isset($_GET["scid"]))
								...
								$scid = $_GET["scid"];
								include "db.php";
								$product_query = "SELECT * FROM products where sub_cateid = $scid";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
			...
			<div class="single-items">
								<div class="row">
									...
									<div class="col-lg-8">
										...
										<a href="pro_details.php?id=<?php echo $pro_id; ?>" class="img-preview-btn">	<h2><?php echo $pro_title;?></h2> </a>
					...
					?><?php 
...

					   {
						...
						<?php
									...
									?>
<br> <br>
								<center> <h1 style="color:red;"> There is no product to show </h1>  </center>
<br> <br>
                                  <?php									
