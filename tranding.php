...
<section class="product-catagory">
			...
			<div class="row">
				<div class="col-lg-9 wrap-title">
					<ul class="title_breadcrumb">
						...
						<li><a href="tranding.php" class="active">Tranding products</a></li>
					</ul>
				</div>
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			<div class="col-lg-9">
				<div class="right-side-area">
					<h1 class="page-title">Tranding Products</h1>
					...
					<div class="tab-content ProductCatagoryView">
						<div id="grid-view" class="tab-pane GridProductView fade in active show">
							...
							<?php
								...
								$product_query = "SELECT * FROM products  LIMIT 0,20 ";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
	...
	if(mysqli_num_rows($run_query1) > 0){
		...
		while($row1 = mysqli_fetch_array($run_query1)){
			...
			$total_of_rate = $row1['total'];
			$user = $row1['total_user'];
			if($user >0){
