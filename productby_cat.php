		...
		while($row = mysqli_fetch_array($run_query)){
			...
			?>
							...
							$limit = 5;
								...
								$sscat = $_GET["scid"];
								include "db.php";
								$product_query = "SELECT * FROM products where sub_cateid = $sscat LIMIT $start,$limit";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			<div class="col-lg-9">
				<div class="right-side-area">
					<h1 class="page-title">Soumi's can</h1>
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			<div class="col-lg-3 pd" style="float:left">
									...
									<?php 
										...
										<div class="items-img">
											<img src="images/<?php echo $pro_image ;?>" style="height:150px;width:200px;">
