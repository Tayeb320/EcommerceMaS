 <?php include"header.php";?>
  <div class="col-lg-12">
                   <center> <h2 style="background-color:#0B0B3B;padding:30px;color:white;"> Marque Settings </h2></center> <hr/>
                </div>
            ...
            <div class="col-lg-10">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="index.php">Home</a> <a href="marque.php"> / Marque</a>
                    </li>
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1"> Marque</a></li>
							...
							if(isset($_POST["about"]))
								...
								$desc = $_POST["description"];	
								  ...
								  $sql = "UPDATE marque SET description ='$desc'
							  WHERE id = $id ";
										
										if(mysqli_query($con,$sql)){
											echo "<div class='alert alert-info'>
															<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
															<b>Marque is updated</b>
													</div>";
