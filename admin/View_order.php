...
th {
 ...
 <div class="col-lg-12">
                   <center> <h2 style="background-color:#0B0B3B;padding:30px;color:white;">All Orders</h2></center> <hr/>
                </div>
 ...
 <div id="page-wrapper" style="overflow:scroll;">
    ...
    <tbody>
							...
							$product_query = "SELECT *,sum(total) as totalprice, sum(qty) as totalQuantity from orders group by tnx_id ORDER BY order_id DESC";
